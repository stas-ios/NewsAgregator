...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_dsym "${PODS_ROOT}/RxAlamofire/RxAlamofire.framework.dSYM"
  install_framework "${PODS_ROOT}/RxCocoa/RxCocoa.framework"
  install_dsym "${PODS_ROOT}/RxCocoa/RxCocoa.framework.dSYM"
  install_framework "${PODS_ROOT}/RxKingfisher/RxKingfisher.framework"
  install_dsym "${PODS_ROOT}/RxKingfisher/RxKingfisher.framework.dSYM"
  ...
  install_framework "${PODS_ROOT}/Swinject/Swinject.framework"
  install_dsym "${PODS_ROOT}/Swinject/Swinject.framework.dSYM"
  install_framework "${BUILT_PRODUCTS_DIR}/Viper/Viper.framework"
  install_framework "${PODS_ROOT}/XMLCoder/XMLCoder.framework"
  install_dsym "${PODS_ROOT}/XMLCoder/XMLCoder.framework.dSYM"
